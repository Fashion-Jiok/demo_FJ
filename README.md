...
npm run dev
```
지금 아주 중요한 실수를 하고 계십니다! 🚨

백엔드 폴더(backend)에서 프론트엔드 실행 명령어(npx expo start)를 입력하셨습니다. 그래서 Expo가 백엔드 폴더를 앱 프로젝트로 착각하고 실행하려고 하다가 이상한 에러(opendir... Operation not permitted)가 쏟아지는 것입니다.
...
cd ..
# (또는 cd /Users/so0som/Desktop/생성형AI/FJ_new)
